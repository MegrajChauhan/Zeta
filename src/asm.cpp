...
zeta::Masm::Masm(int argc, char **argv)
{
    this->argc = argc-1;
...
void zeta::Masm::print_help()
{
    std::cout << "Usage: zeta <path_to_file> [OPTIONS]<Additional Arguments>\n";
...
std::pair<bool, std::string> zeta::Masm::get_option(std::string opt_name)
{
